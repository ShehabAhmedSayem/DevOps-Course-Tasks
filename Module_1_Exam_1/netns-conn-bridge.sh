...
# Set default routes
sudo ip netns exec ns1 ip route add default via 192.168.0.1
sudo ip netns exec ns2 ip route add default via 192.168.0.1
sudo ip netns exec ns3 ip route add default via 192.168.0.1
sudo ip netns exec ns4 ip route add default via 192.168.0.1
